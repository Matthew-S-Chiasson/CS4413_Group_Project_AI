...
parser.add_argument("--UseDP", type=str, default="false", help="Weather to use DP in training or not.")
parser.add_argument("--poison_active", type=str, default="false", help="Weather to use Data poisoning in training or not.")
...
parser.add_argument("--save_path", type=str, default="Train_Resnet18_FL.pth", help="Path to save the updated model")
...
def simulate_federated_learning():
    ...
    def client_fn(cid: str):
        ...
        return FlowerClient(client_model, client_loaders[int(cid)], device).to_client()
